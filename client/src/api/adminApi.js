...
export const adminLogin = async (email, password) => {
  const { data } = await $host.post("api/user/login-admin", {
    email,
    password,
  });
...
export const fetchSaleStatistic = async (startDate, lastDate) => {
  const { data } = await $authAdminHost.get("api/order/salestatistic", {
    params: { startDate, lastDate },
  });
  return data;
};
...
export const fetchUserStatistic = async (startDate, lastDate) => {
  const { data } = await $authAdminHost.get("api/user/userstatistic", {
    params: { startDate, lastDate },
  });
  return data;
};
...
export const fetchUsers = async (userId, name, email, limit, page) => {
  const { data } = await $authAdminHost.get("api/user/all", {
    params: {
      userId,
      name,
      email,
...
export const fetchOrders = async (id, email, limit, page) => {
  const { data } = await $authAdminHost.get("api/order/all", {
    params: {
      id,
      email,
      limit,
...
export const fetchProducts = async (
  ...
  const { data } = await $authAdminHost.get("api/product/all-admin", {
    params: {
      categoryId,
      name,
      page,
...
export const fetchPromocodes = async (limit, page) => {
  const { data } = await $authAdminHost.get("api/promo/all", {
    params: {
      limit,
      page,
    },
...
export const createPromocode = async (
  ...
  const { data } = await $authAdminHost.post("api/promo", {
    promocode,
    percentDiscount,
    expirationDate,
  });
...
export const updatePromocode = async (
  ...
  const { data } = await $authAdminHost.put("api/promo", {
    id,
    promocode,
    percentDiscount,
    expirationDate,
...
export const fetchCategories = async (limit, page) => {
  const { data } = await $authAdminHost.get("api/category/all-admin", {
    params: {
      limit,
      page,
    },
