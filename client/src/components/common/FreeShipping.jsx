...
const FreeShipping = () => {
  ...
  return (
    <div className="freeshipping">
      <ProgressBar progress={cardSubTotal <= 100 ? cardSubTotal : 100} />
      ...
      {isShippingFree ? (
        ...
        <div className="shipping-not-free">
          <div className="getfree-text">
            Get Free <span className="span-shipping">Shipping</span> for orders
            over <span className="span-100">$100.00</span>
          </div>
          <Link to="/shop">
