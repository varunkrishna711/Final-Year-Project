...
const AddReview = (e) => {
  ...
  const addReview = (e) => {
    ...
    dispatch(
      addProductReview({ userId, productId: id, name, rate, review })
    ).then((data) => {
  ...
  return (
    <form className="addreview" id="addreview-form" onSubmit={addReview}>
      <div className="maintext">Add Review</div>
      <div className="add-rating">
        <div className="add-rating-text" ref={ratingRef}>
          Your rating <span>*</span>
        </div>
        <div className="rating">
          <AddRating changeRate={changeRate} />
        </div>
      </div>
      <div className="write-name">
        <div className="your-name-text" ref={nameRef}>
          Your name <span>*</span>
        </div>
        <input
      ...
      <div className="write-review">
        <div className="your-review-text" ref={reviewRef}>
      ...
      {isLogin ? (
        ...
        <div className="review-nologin">
          <span onClick={toLogin}>Login</span> or{" "}
          <span onClick={toSignUp}>Sign Up</span> to add review.
        </div>
      )}
    </form>
  );
