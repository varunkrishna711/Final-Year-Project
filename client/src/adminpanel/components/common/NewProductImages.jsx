...
const NewProductImages = (props) => {
  ...
  return (
    <div className="newproductimages">
      <div className="newproductimages-header">Product Media</div>
      <div className="image-gallery">
        <div className="relative add-image">
          ...
          {images.map((image, index) => (
            <li className="image-list-item" key={index}>
              ...
              <div className="item-image-info">
                {images[0] === image && (
                  <div className="item-main-image">Main image</div>
                )}
                <div className="info-text">{image.name}</div>
